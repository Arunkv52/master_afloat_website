...
import Img1 from '../../assets/services/vessel_name/1.png'
import Img2 from '../../assets/services/vessel_name/2.png'
import Img3 from '../../assets/services/vessel_name/3.png'
import Img4 from '../../assets/services/vessel_name/4.png'
import Img5 from '../../assets/services/vessel_name/5.png'
    ...
    <>
      <div className>
        ...
        <div className='px-5 py-30'>
          <h2 className='text-3xl text-center'>Vessel Name Change</h2>
          <Carousel>
            <CarouselContent>
